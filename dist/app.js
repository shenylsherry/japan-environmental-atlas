...
async function init(){try{load();renderLayers();client=createTerrainClient();
 ...
 for(const kind of ['elevation','slope','aspect','curvature','terrain']){sources[kind]={type:'raster',tiles:[`terrain://${kind}/{z}/{x}/{y}.png`],tileSize:256,minzoom:11,maxzoom:14,bounds:[122,20,154,46.5],attribution:'地形：国土地理院 DEM / Kinoko Map 派生'};mapLayers.push({id:kind,type:'raster',source:kind,minzoom:11,layout:{visibility:'none'},paint:{'raster-resampling':'nearest','raster-fade-duration':0}});}
